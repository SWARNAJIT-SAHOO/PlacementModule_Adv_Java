     ...
     <% try {		
		...
		String ps="select * from admindata  ";
   		...
   		<tr>
			...
			<td style=""><button type="button"class="btn btn-outline-danger">Register</button></td>
...
%>
        ...
        box-shadow: 0px 0px 15px 5px rgba(173, 216, 230, 0.8);
         margin-top: 15rem;">
        <a href="" style="margin-left:.75rem;">
        <button type="submit" class="btn btn-outline-info">Know More</button>
        </a>
        </div>        
